...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="assets/img/icon/favicon.jpg" type="image/x-icon">
    ...
    <title>Beadslyy.id</title>
</head>

<body>
    <header>
        <nav class="navbar fixed-top navbar-expand-lg navbar-light m-0 p-0" style="background-color:#fdc0c5;">
            <div class="container pl-3 pr-3">
                <a class="" href="#">
                    <img src="assets/img/icon/Logo01.png" width="100" height="30" alt="">
                </a>
